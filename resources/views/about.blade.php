...
<div class="page-wrap">
    <header class="topbar">
        ...
        <nav class="pill-nav">
            ...
            <a class="pill-nav__link" href="/contact">Contact</a>
            ...
            <div class="contact-inner">
                ...
                <form class="contact-form" action="#" method="POST">
                    ...
                    <div class="form-field">
                        ...
                        <input class="form-input" id="full_name" name="full_name" type="text" placeholder="e.g Mary Jude" required>
                    </div>
                    <div class="form-field">
                        <label class="form-label" for="email">Email address</label>
                        <input class="form-input" id="email" name="email" type="email" placeholder="e.g mayjude54@gmail.com" required>
                    </div>
                    <div class="form-field">
                        <label class="form-label" for="role">Your role</label>
                        <select class="form-input form-select" id="role" name="role">
                    ...
                    <div class="form-field">
                        ...
                        <textarea class="form-input form-textarea" id="message" name="message" placeholder="Tell us about your interests in the platform" rows="4"></textarea>
                    </div>
